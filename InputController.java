...
public class InputController implements KeyListener {
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (key == KeyEvent.VK_W || key == KeyEvent.VK_A || key == KeyEvent.VK_S || key == KeyEvent.VK_D) {
            ...
            switch (key) {
                case KeyEvent.VK_W:
                    if ((pressedKeys & (1 << (KeyEvent.VK_S - KeyEvent.VK_A))) != 0) currentDirection |= DOWN;
                    break;
                case KeyEvent.VK_A:
                    if ((pressedKeys & (1 << (KeyEvent.VK_D - KeyEvent.VK_A))) != 0) currentDirection |= RIGHT;
                    break;
                case KeyEvent.VK_S:
                    if ((pressedKeys & (1 << (KeyEvent.VK_W - KeyEvent.VK_A))) != 0) currentDirection |= UP;
                    break;
                case KeyEvent.VK_D:
                    if ((pressedKeys & (1 << (KeyEvent.VK_A - KeyEvent.VK_A))) != 0) currentDirection |= LEFT;
                    break;
                default:
                    break;
            }
